...
#2018_0918: EXTRACTING ALL NOUNS. 
#         2nd step: combine nouns, rank by frequency-sentiment. and manually tag proper nouns/goog news
#         3rd step: add back in the dictionary match. 

##########################################
####### EXECUTE
##########################################
## Open input file, loop, write
